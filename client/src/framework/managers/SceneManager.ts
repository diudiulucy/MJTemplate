...
module LC {
    export class SceneManager extends Single {
        ...
        private _runningScene: LC.Scene = null;
        private _scenesStack: Array<LC.Scene> = [];
        ...
        public runWithScene(scene: LC.Scene) {
        ...
        public replaceScene(scene: LC.Scene) {
        ...
        public pushScene(scene: LC.Scene) {
